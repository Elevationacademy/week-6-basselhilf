...
Person.find(({height:{"$gt":180},salary:{"$gt":30000}}),function(err,books){})
...
Person.find.find().and([{$or:[{hair:"grey"}, {eyes:"grey"}]},{weight:{"$lt":70}}]).exec(function(err,people){})
...
Person.find().and([{weight: {"$gt":100}},{kids:{$elemMatch:{weight: {"$gt":100}}}}]).exec(function(err, people){})